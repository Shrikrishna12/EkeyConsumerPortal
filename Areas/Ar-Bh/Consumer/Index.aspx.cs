...
namespace TRAWebApplication.Ar_Bh
{
    public partial class Index : System.Web.UI.Page
    {
        ...
        public Token reqAuthCRM(string consumerid)
        {
            ...
            var abc = client.PostAsync(baseAddress + "/token", new FormUrlEncodedContent(form)).Result;

            var jsonContent = abc.Content.ReadAsStringAsync();

            Token tok = JsonConvert.DeserializeObject<Token>(jsonContent.Result.ToString());
            return tok;
        }
    }
}